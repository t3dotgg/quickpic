        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mb-8">
              Hi, I'm <a href="https://www.linkedin.com/in/antonio-archer/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">Archer</a>. 
              <a href="https://twitter.com/t3dotgg" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors"> Theo</a> built this site because he was annoyed. 
              I built this version because I thought it was cool and HEIC files annoy me.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white dark:bg-gray-900">
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* SVG Converter */}
            <Link href="/svg-to-png" className="rounded-lg border border-gray-200 bg-white text-gray-900 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50 p-6 hover:shadow-md transition-shadow">
            ...
            {/* WebP Converter */}
            <Link href="/webp-converter" className="rounded-lg border border-gray-200 bg-white text-gray-900 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50 p-6 hover:shadow-md transition-shadow">
            ...
            {/* HEIC Converter */}
            <Link href="/heic-to-png" className="rounded-lg border border-gray-200 bg-white text-gray-900 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50 p-6 hover:shadow-md transition-shadow">
