...
function SquareToolCore(props: { fileUploaderProps: FileUploaderResult }) {
    ...
    return (
        <div className="mx-auto flex flex-wrap lg:flex-nowrap items-center justify-center gap-6 p-6">
            <div className="flex w-full flex-col items-center gap-4 rounded-xl p-6">
                {squareImageContent && (
                    <img src={squareImageContent} alt="Preview" className="mb-4 max-h-[600px]" />
                )}
                <p className="text-lg font-medium text-white/80">
                    {imageMetadata.name}
                </p>
            </div>
            <section className="flex max-w-2xl flex-col items-center justify-center gap-6 p-6 border min-w-fit">
                <div className="flex gap-6 text-base">
                    <div className="flex flex-col items-center rounded-lg bg-white/5 p-3 min-w-fit">
